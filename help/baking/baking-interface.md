...
O modo de cozimento altera o layout da interface do usuário e disponibiliza diferentes painéis especificamente para a cozimento de mapas de malha.
...
>[!NOTE]
>
> Consulte [**Configurações do mapa de malha**](mesh-map-settings.md) para obter uma lista completa de opções disponíveis nos **Painéis Configurações comuns** e **Configurações do mapa de malha**.

Painéis adicionais estão disponíveis e se comportam da mesma forma que no **modo Pintura**:

<table>
  <tr style="border: 0;">
    <td style="border: 0;" valign="top"><img src="../assets/right-bar.png" alt=""/></td>
    <td style="border: 0;" valign="top"><ul><li><a href="../interface/texture-set/texture-set-list.md"><strong>Lista do conjunto de texturas</strong></a></li><li>Disponível na barra à direita:<ul><li><a href="../interface/miscellaneous/log.md"><strong>Log</strong></a></li><li><a href="../interface/display-settings/display-settings.md"><strong>Configurações do visor</strong></a></li><li><a href="../interface/history.md"><strong>Histórico</strong></a></li></ul></li></ul></td>
  </tr>
</table>