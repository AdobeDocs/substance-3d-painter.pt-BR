---
helpx_url: "https://helpx.adobe.com/br/substance-3d-painter/release-notes/old-versions/version-2021-1-7-1-0.html"
breadcrumb-title: ''
...
Os efeitos agora podem ser copiados entre camadas e pilhas de camadas, da mesma maneira que as camadas normais.
...
* **Adicionar uma descrição por Bloco UV**\
  Uma descrição agora pode ser adicionada para cada Bloco UV por meio da Lista de conjuntos de texturas. Isso facilita a navegação no projeto, especialmente ao exportar e fazer bake, pois as descrições também podem ser vistas nesses contextos.\
...
* **Novas miniaturas de pilha de camadas**\
  As miniaturas de pilha de camadas otimizadas foram aprimoradas. Agora é exibida uma esfera de material para camadas de preenchimento, facilitando a navegação e a visualização das propriedades principais de cada camada, mesmo ao trabalhar com o fluxo de trabalho [Blocos UV](../../features/uv-tiles/uv-tiles.md). A miniatura é gerada a partir das informações da camada, mas não leva em conta os efeitos para evitar que sejam recalculadas com muita frequência.

  ![](../../assets/layer-stack-thumbnails.png)

* **Saída da Máscara de geometria aprimorada na pilha de camadas**\
  Sair da Máscara de geometria (anteriormente chamada de Máscara de Bloco UV) pode ser difícil com as pastas na pilha de camadas se não tiver uma máscara. Isso ocorre porque não havia outro contexto para ativar além da seleção de outra camada. Agora é possível clicar na miniatura da pasta para sair da Máscara de geometria. Também é possível arrastar e soltar materiais ou materiais inteligentes da prateleira no visor ao editar a Máscara de geometria.

  ![](../../assets/geo-mask-folder.gif)

  ![](../../assets/drag-drop-geo-mask.gif)

* **Nova seleção de clique com a tecla Alt pressionada na janela de Fça bake**\
  A lista de mapas de malha na janela de fça bake agora pode ser isolada com o **Alt + clique do mouse** para isolar um mapa específico para fazer bake, em vez de ter que excluí-los manualmente. O mesmo atalho pode ser usado para reativar todos os mapas de malha.

  ![](../../assets/baking-alt-click.gif)

* **Botão Novo faço bake do Conjunto de Texturas atual**\
  Um novo botão foi adicionado na parte inferior da janela de Fça bake para tornar mais rápido e fácil fazer bake novamente um conjunto de texturas. Usar esse botão não afetará a seleção personalizada que foi definida anteriormente e, em vez disso, fará bake todo o conjunto de texturas (incluindo todos os seus Blocos UV, se houver).
...
Para obter mais detalhes sobre os novos recursos Substance Engine, confira [esta página de documentação](https://helpx.adobe.com/br/substance-3d/unlisted/documentation/sddoc/version-2020-2-10-2-0-200574252.html).
...
É recomendável ativar o recurso [Atraso do mouse](../../painting/lazy-mouse.md) na barra de ferramentas contextual para aumentar a qualidade dos pontos pintados.
...
Resumo: **Versão principal, nova Máscara de Geometria que permite selecionar e tinta partes da geometria, copiar/colar efeitos na pilha de camadas, melhoria do fluxo de trabalho do Bloco UV, atualização da Iray, Baker, Substance Engine e novo conteúdo**
