...
breadcrumb-title: ''
description: Use a ferramenta Borracha no Substance 3D Painter para remover tinta e texturas de seus modelos 3D com controle de precisão.
...
A Borracha é uma ferramenta de tinta que apaga/oculta o que foi pintado anteriormente por outras ferramentas. Essa ferramenta afeta apenas uma camada por vez.

A Borracha compartilha parâmetros e comportamentos comuns com a ferramenta de Tinta. Para saber mais sobre os controles pincel, alfa e estêncil, confira a [página da ferramenta Tinta](paint-brush.md).
...
> * Um filtro Substance pode recuperar as informações de tinta se ignorar as informações alfa
> 
...
>[!NOTE]
>
> Ao contrário da ferramenta Tinta, a Borracha só permite definir quais canais serão afetados. Não é possível carregar um recurso da Prateleira para afetar cada canal.
