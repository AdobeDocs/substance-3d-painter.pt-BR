...
breadcrumb-title: ''
description: Use a simetria radial no Substance 3D Painter para tinta simetricamente ao redor de um ponto central a fim de criar padrões circulares.
...
![Uma captura de tela do painel de configurações da simetria radial com o manipulador visível no visor.](../../assets/RadialSymmetryManip.png){width="600px"}
