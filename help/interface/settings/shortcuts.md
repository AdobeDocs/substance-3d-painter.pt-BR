...
Esta página lista todos os atalhos de teclado e mouse disponíveis.
...
![](../../assets/shortcut-edit.gif)Clique no ícone de “caneta” ao lado de um atalho para editá-lo e inserir a nova combinação.Pressionar a última tecla sairá automaticamente do modo de edição e alterará o atalho.

### Lista de atalhos editáveis

Para restaurar um atalho ao seu valor padrão, basta clicar com o botão direito nele.

| *Ação* | *Atalho (Windows)* | *Atalho (MacOS)* | *Descrição* |
| --- | --- | --- | --- |
...
| **Fechar projeto** | Ctrl+F4 | ⌘+W | Fechar o projeto atual. |
| **Salvar projeto** | Ctrl+S | ⌘+S | Salva o projeto atual. |
| **Salvar como projeto** |  |  | Salva o projeto atualmente aberto com um novo nome. |
...
| **Giro de instantâneo da câmera** | Alt+Shift+Mouse para a esquerda | Shift+⌘+Seta para a esquerda | Ajuste a rotação da câmera a cada ângulo de 90 graus. |
| **Conversão de câmera** | Alt+Botão do meio do mouse | Option+⌘+Mouse para esquerda |  |
| **Conversão de câmera (alternativa)** | Ctrl+Alt+Mouse para a esquerda |  |  |
| **Zoom da câmera** | Alt+Mouse para a direita | Mouse do meio |  |
| **Rotação de estêncil** | S+Mouse para a esquerda | S+Mouse para a esquerda |  |
| **Rotação de snap de estêncil** | Shift+S+Mouse para a esquerda | Shift+S+Mouse para a esquerda |  |
| **Tradução de estêncil** | S+Botão do meio do mouse |  |  |
| **Zoom do estêncil** | S+Botão direito do mouse | S+Botão direito do mouse |  |
| **Alterar tamanho/dureza da ferramenta** | Ctrl+Mouse para a direita | ⌘+Mouse para a direita | Altere o tamanho movendo horizontalmente e altere a dureza do pincel movendo verticalmente. |
| **Alterar fluxo/rotação da ferramenta** | Ctrl+Mouse para esquerda | ⌘+Mouse para esquerda | Altere o fluxo do pincel atual movendo-se horizontalmente e altere a rotação do pincel movendo-se verticalmente. |
| **Girar ambiente** | Shift+Mouse para a direita | Shift+Mouse para a direita | Gire horizontalmente o mapa de ambiente usado para a iluminação no visor. |
| **Foco automático (Profundidade de campo)** | Ctrl + botão do meio do mouse |  |  |
| **Seleção de conjunto de textura** | Ctrl+Alt+Mouse para a direita | Option+⌘+Mouse para a direita |  |
| **Menu de contexto** | Mouse para direita | Mouse para direita | Menu rápido para acessar a janela de propriedades dentro do visor. |
| **Definir local de origem da ferramenta Clonar** | V+Mouse para a esquerda | V+Mouse para a esquerda |  |
|  |  |  |  |
| **Ignorar máscara de estêncil** | N | N | Desabilita temporariamente o estêncil (evita removê-lo por completo). |
| **Retomar traço anterior** | A | A | Permita que o continue com o traçado de pincel criado anteriormente para evitar descontinuidades. |

## Lista de atalhos não editáveis

Alguns atalhos podem **funcionar** apenas se o **mouse estiver sobre** a janela específica.

Exemplo: **copiar** e **colar** requer que o mouse esteja **sobre a pilha de camadas**.

| *Ação* | *Atalho (Windows)* | *Atalho (MacOS)* | Descrição |
| --- | --- | --- | --- |
| **Copiar camada** | Ctrl+C | ⌘+C | Copiar a(s) camada(s) selecionada(s) no momento. |
| **Cortar camada** | Ctrl+X | ⌘+X | Recorta a( s) camada( s) atualmente selecionada( s). |
| **Colar camada** | Ctrl+V | ⌘+V | Cole a camada na(s) memória(s). |
| **Excluir camada** | Excluir | Excluir | Exclui a(s) camada(s) atualmente selecionada(s). |
| **Duplicar camada** | Ctrl+D | ⌘+D | Duplica as camadas atualmente selecionadas. |
| **Agrupar camada** | Ctrl+G | ⌘+G | Coloca as camadas atualmente selecionadas em uma pasta. |
| **Copiar conteúdo da camada** | Ctrl+Shift+C | Option+⌘+C | Copie o conteúdo da camada (pintura) e seus efeitos. |
| **Colar conteúdo da camada** | Ctrl+Shift+V | Option+⌘+V | Cole o conteúdo (pintura) e os efeitos atualmente na memória. |
| **Exibir máscara no visor** | Alt+Mouse para a esquerda | Option+Mouse para a esquerda | Alterna o modo de exibição do visor para a máscara da camada especificada. |
| **Desabilitar/Habilitar máscara** | Shift+Mouse para a esquerda | Shift+Mouse para a esquerda | Alterna o estado da máscara em uma camada. |
|  |  |  |  |
