...
helpx_learn_topic: ""
helpx_tags: ""
title: Configuração de bibliotecas
...
Esta seção permite especificar caminhos personalizados para pastas de recursos adicionais e em que local os recursos devem ser salvos por padrão.

## Caminhos padrão

Por padrão, dois caminhos são predefinidos:
...
>[!NOTE]
>
> Um caminho só pode ser criado/modificado se nenhum projeto estiver aberto no momento.
