...
* Também é possível adicionar um local diferente da biblioteca. Para isso, observe [Adicionando uma nova biblioteca](adding-a-new-library.md).

## Visão geral

A janela Ativos é dividida em três seções principais por padrão:
...
Para obter mais informações, consulte a [Página de navegação](navigation.md).
