---
helpx_url: "https://helpx.adobe.com/br/substance-3d-painter/interface/display-settings/viewport-settings.html"
breadcrumb-title: ''
...
| *Configuração* | *Descrição* |
| --- | --- |
| **Ocultar estêncil ao pintar** | Ao usar um estêncil (consulte as propriedades da ferramenta tinta), esta configuração permite ocultá-lo temporariamente ao pintar na malha. |
...
| **Usar cor +/- para valores HDR** | Essa configuração permite visualizar mais facilmente a textura por HDR substituindo valores positivos pela primeira cor e valores negativos pela segunda cor. Os valores neutros (0) são pretos.Exemplo: <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table1_row-r3-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/colored-hdr.jpg"/></div> |
