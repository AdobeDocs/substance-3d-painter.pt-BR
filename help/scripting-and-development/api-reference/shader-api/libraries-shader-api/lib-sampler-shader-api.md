...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib Sampler - API de sombreamento
...
# Lib Sampler - API de sombreamento

## lib-sampler.glsl

**Funções Públicas:** *getAO* *getShadowFactor* *getGlossiness* *getRoughness* *getMetallic* *getAnisotropyLevel* *getAnisotropyAngle* *getOpacity* *getHeight* *getBaseColor* *getSpecularLevel* *getBaseColor* *getDiffuse* *getSpecularColor* *getScattering* *generateAnisotropicRoughness* *generateDiffuseColor* *generateSpecularColor*
...
Cores padrão de fundo quando não há dados no canal (alfa é 0)
...
Retornar brilho de amostra ou um valor padrão
...
Retornar aspereza de amostra ou um valor padrão
...
Retornar amostra metálica ou um valor padrão
...
Retornar ângulo de anisotropia de amostra ou um valor padrão
...
Retornar opacidade de amostra ou um valor padrão
...
Retornar height de amostra ou um valor padrão
...
Retornar deslocamento de amostra ou um valor padrão
...
Buscar o fator de sombra (espaço da tela)
...
Retornar cor de base de amostra ou um valor padrão
...
Retornar amostra de cor difusa ou um valor padrão
...
Retornar a cor do specular de amostra ou um valor padrão
...
Retornar um valor de dispersão de amostra ou um valor padrão
