...
breadcrumb-title: ''
description: Acesse a Lib Define a referência de API de sombreamento do Substance 3D Painter para definir constantes de sombreador e diretivas de pré-processador.
