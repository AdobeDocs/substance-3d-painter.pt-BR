---
helpx_url: "https://helpx.adobe.com/br/substance-3d-painter/scripting-and-development/api-reference/shader-api/libraries-shader-api/lib-pbr-shader-api.html"
breadcrumb-title: ''
description: Acesse a referência Lib PBR API de sombreamento para o Substance 3D Painter para criar materiais de renderização baseados fisicamente em sombreadores personalizados.
...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib PBR - API de sombreamento
...
# Lib PBR - API de sombreamento

## lib-pbr.glsl

**Funções Públicas:** *normal\_distrib* *afresco* *G1* *visibilidade* *horizonFading* *pbrComputeDiffuse* *pbrComputeSpecular* *pbrComputeBRDF*

Número de níveis de pixel no mapa de ambiente.
...
Um int que representa o número de amostras feitas para o cálculo da contribuição de specular. Quanto maior a qualidade e o impacto no desempenho.
...
Valor usado para controlar o vazamento do reflexo do specular pela superfície.
...
Importar da biblioteca, outros parâmetros
...
Truque de desvanecimento horizontal de <https://marmosetco.tumblr.com/post/81245981087>
...
Calcular o brilho difuso lambertiano para o olho do espectador
...
Calcular o reflexo do specular das microfacetas para o olho do espectador
