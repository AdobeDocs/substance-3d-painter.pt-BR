...
helpx_learn_topic: ""
helpx_tags: ""
title: Lib Pom - API de sombreamento
...
# Lib Pom - API de sombreamento

## lib-pom.glsl

**Funções Públicas:** *getParallaxOffset* *applyParallaxOffset*
...
Uniformes relacionados ao mapeamento de oclusão de paralaxe
...
Calcular o deslocamento das coordenadas de textura com base na paralaxe
...
Atualizar coordenadas de textura de entrada com deslocamento de paralaxe
