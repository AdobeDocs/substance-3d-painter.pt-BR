...
helpx_learn_topic: ""
helpx_tags: ""
title: Localização de prateleiras e ativos
...
# Localização de prateleiras e ativos

Esta página lista o local dos Ativos (ou Prateleira para versões antigas) para cada plataforma.Este caminho é onde o conteúdo do usuário - como salvar predefinições na janela Ativos - e os plug-ins estão localizados por padrão.
