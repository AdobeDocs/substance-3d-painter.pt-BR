...
| **—vram-budget** | Substituir o orçamento da memória de vídeo (VRAM) definido pelo mecanismo do Substance 3D Painter. “Quantidade” é em megabytes.    Exemplo: `// Set the VRam budget to 2GB   "Adobe Substance 3D Painter.exe" --vram-budget 2048` |
