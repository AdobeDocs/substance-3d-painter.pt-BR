---
helpx_url: "https://helpx.adobe.com/br/substance-3d-painter/technical-support/performances-guidelines/gpu-drivers.html"
breadcrumb-title: ''
description: Saiba mais sobre os requisitos de VRAM e driver da GPU para o Substance 3D Painter otimizar o desempenho e a estabilidade da renderização.
...
## Quantidade e largura de banda de GPU VRAM
...
O Painter funciona transferindo texturas para a memória de GPU (VRAM) para realizar os cálculos (como operações de mesclagem para criar as texturas finais). No entanto, se o VRAM estiver começando a ficar cheio, as texturas não utilizadas serão transferidas de volta para a RAM do computador para o espaço livre do VRAM. O Substance 3D Painter grava e lê GBs de dados durante o trabalho. Isso significa que tanto a capacidade do VRAM (quantidade) quanto a velocidade da largura de banda ao fazer transferências são importantes. Você pode usar ferramentas como o [MSI AfterBurner](https://www.msi.com/page/afterburner) para monitorar esse comportamento.
