...
description: Saiba como usar o gerador de Oclusão de ambiente do Substance 3D Painter.
...
<table>
  <tr style="border: 0;">
    ...
    <td style="border: 0;" valign="top"><strong>Descrição</strong><br>O gerador de Oclusão de ambiente cria uma máscara com base no mapa de Oclusão de ambiente feito bake com a opção de mesclar uma textura ou microdetalhes na máscara.<br><br>Se estiver usando o gerador de Oclusão de ambiente para criar uma máscara de camada, talvez seja necessário inverter a saída da Oclusão de ambiente. Por padrão, o gerador gera a saída de áreas ocultas como áreas escuras e não ocultadas como claras. Se usada como máscara, a camada mascarada ficará visível somente em áreas não ocultadas. Inverter a saída garantirá que a camada mascarada apareça apenas em áreas ocultadas.<br><br>Mapas normais de posição, oclusão de ambiente e espaço global Feitos bake são necessários como entradas de imagem. <a href="../../../baking/baking.md">Saiba mais sobre como fazer bake aqui</a>.</td>
  </tr>
</table>
...
| --- | --- |
| Textura cor | Use uma textura personalizada ou um ponto de ancoragem. |
...
| Cor dos normais do espaço mundial | Use o mapa do World Space Normals feito bake. |
| Cor do gradiente da posição | Use o mapa de Posição feita bake. |
...
| Nome do parâmetro | Descrição |
| --- | --- |
| **Inverter** | Inverta apenas Oclusão de ambiente e microdetalhes. |
| **Desfoque** | Suavize apenas Oclusão de ambiente e microdetalhes. |
| **Saldo** | Ajuste o equilíbrio apenas dos microdetalhes da Oclusão de ambiente e, alternando o ponto médio em direção ao preto ou branco, como um controle de brilho. |
| **Contraste** | Ajuste apenas o contraste/declínio da Oclusão de ambiente e dos microdetalhes. |
...
| Nome do parâmetro | Descrição |
| --- | --- |
| **Micro Height** | Ativar ou desativar o uso de um mapa de altura Micro personalizado. |
| **Micro normal** | Ativar ou desativar o uso de um Micro Mapa normal personalizado. |
| **Raio do AO** | Ajuste o raio (intervalo) da Oclusão de ambiente em microdetalhes. |
| **Profundidade AO** | Ajuste a profundidade (intensidade) da Oclusão de ambiente em microdetalhes. |
